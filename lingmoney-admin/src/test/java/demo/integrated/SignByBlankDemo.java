...
import com.enjoysign.sdk.pdf.security.TSAClientBouncyCastle;

import demo.SDKConstants;

/**
 * 空白签章，仅在签章区显示一条签名，在pdf表层不叠加任何印章。
 *
 */
public class SignByBlankDemo {

	private static final Logger log = LoggerFactory
			.getLogger(SignByBlankDemo.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 生成签章外观，空白签章，仅在签章区显示一条签名，在pdf表层不叠加任何印章。适用于平台方创建文档，或者保全文档使用。
			PdfSignatureAppearance sap = SignAppearanceGenerator
					.signBlank(pdfReader, serialNo);
			...
			// 签署人手机号(个人签署时必须传递)
			receiver.put("phone", "18163327378");
			// 签署人证件类型 0=居民身份证,1=护照,8=企业营业执照
			receiver.put("cardType", "0");
			// 签署人证件号
			receiver.put("cardNumber", "118105198912020258");
			// 签署人真实姓名
			receiver.put("realName", "张左2");
			// 签署人邮箱（企业签署时必须传递）
			...
			PdfReader.savePdfFile(signedPdfBytes, "d:/blank.signed.pdf");
			log.info("签署完毕，文档已保存到" + "d:/" + "blank.signed.pdf");
