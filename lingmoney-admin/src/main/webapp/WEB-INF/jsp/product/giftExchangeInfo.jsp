...
<head>
<meta charset="UTF-8">
<title>拉新活动礼品兑换</title>
<jsp:include page="/common/head.jsp"></jsp:include>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resource/js/product/giftExchangeInfo.js"></script>
<script type="text/javascript"
	...
	<div class="easyui-layout" style="width: 700px;" fit="true">
		...
		<div id="tb" data-options="region:'center'"
			...
			<table class="easyui-datagrid" title="查询结果" fit='true' id="adGrid"
				data-options="pageList:[10,100,1000],rownumbers:true,singleSelect:true,toolbar:toolbar,fitColumns:false,pagination:true,iconCls:'icon-view',loadMsg:'请稍后，正在加载数据...',idField:'id',collapsible:true,url:'/rest/product/giftExchangeInfo/list?category=0',method:'post'">
				<thead>
					<tr>
