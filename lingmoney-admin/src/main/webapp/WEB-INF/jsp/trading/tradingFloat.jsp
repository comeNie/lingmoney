...
<head>
<meta charset="UTF-8">
<title>浮动类产品分类表</title>
	<jsp:include page="/common/head.jsp"></jsp:include>
	
	<script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/DatePattern.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/trading/trading_float.js"></script>
</head>
<body>
	<div class="easyui-layout" style="width:700px;" fit="true">
	        ...
	        <div id="tb"  data-options="region:'center'" style="padding:5px;height:auto">       
	            <table class="easyui-datagrid" title="查询结果" fit='true' id="adGrid"
		            ...
		            loadMsg:'请稍后，正在加载数据...',idField:'id',collapsible:true,url:'/rest/trading/trading/listFloat',method:'post'">
			        <thead>
			            <tr>
			            	...
			            	<th data-options="field:'inNetValue',width:200" >买入的净值</th>
			            	<th data-options="field:'num',width:200" >买入的数量</th>
			            	<th data-options="field:'outNetValue',width:200" >卖出的净值</th>
			            	<th data-options="field:'profit',width:200" >利润</th>
			            	<th data-options="field:'costValue',width:200" >佣金</th>
			            	<th data-options="field:'sellDt',width:200" formatter="formatTimer">卖出日期</th>
			            	<th data-options="field:'expiryDt',width:200" formatter="formatDate">结息日</th>
			            </tr>
			        </thead>
		    	</table>
	        </div>
			 		...
			 		<tr>
			 			...
			 			<td>
			 				<select class="easyui-combogrid" name="pCode"  style="width:200px" data-options="
						            ...
						            loadMsg:'正在加载,请稍后...',
						            textField: 'name',
						            url: '/rest/product/product/listType',
						            method: 'get',
						            columns: [[
