...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resource/js/info/notice.js"></script>
<link rel="stylesheet"
...
<body>
	<div class="easyui-layout" style="width: 700px;" fit="true">
		...
		<div id="tb" data-options="region:'center'"
			...
			<table class="easyui-datagrid" title="查询结果" fit='true' id="adGrid"
				data-options="singleSelect:true,toolbar:toolbar,fitColumns:true,pagination:true,iconCls:'icon-view',loadMsg:'请稍后，正在加载数据...',idField:'id',collapsible:true,url:'/rest/info/notice/list',method:'post'">
				<thead>
					<tr>
	...
	<div id="DivAdd" class="easyui-dialog"
		...
		data-options="title:'添加站内公告',iconCls: 'icon-add',buttons: '#dlg-buttons'">
	...
	<div id="DivEdit" class="easyui-dialog"
		style="width: 860px; height: 505px; padding: 10px 20px" closed="true"
		resizable="true" modal="true"
		data-options="title:'编辑站内公告',iconCls: 'icon-edit',buttons: '#dlg-buttons'">
