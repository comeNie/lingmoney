...
<head>
<meta charset="UTF-8">
<title>PC首页Banner设置</title>
<jsp:include page="/common/head.jsp"></jsp:include>
<script type="text/javascript" src="/resource/js/info/bigBanner.js"></script>
</head>
<body>
	<div class="easyui-layout" style="width: 700px;" fit="true">
				...
				<table>
					<tr>
						...
						<td><input class="easyui-textbox" name="name" id="bannername"
							style="width: 200px" data-options="prompt:'请输入名称',
							            icons: [{
											iconCls:'icon-remove',
											handler: function(e){
		...
		<div id="tb" data-options="region:'center'"
			...
			<table class="easyui-datagrid" title="查询结果" fit='true' id="adGrid"
				data-options="singleSelect:true,toolbar:toolbar,fitColumns:true,pagination:true,iconCls:'icon-view',loadMsg:'请稍后，正在加载数据...',idField:'id',collapsible:true,url:'/rest/base/bigBanner/list',method:'post'">
				<thead>
					<tr>
						<th data-options="field:'id',width:50">id</th>
						<th data-options="field:'name',width:150">名称</th>
						<th data-options="field:'url',width:300">跳转链接</th>
						<th data-options="field:'path',width:150">图片路径</th>
		...
		<form id="ffEdit" method="post" novalidate="novalidate"
			...
			<table id="tblEdit" class="view">
				...
				<tr>
					<td colspan="2" style="text-align: right; padding-top: 10px">
						<a href="javascript:void(0)" class="easyui-linkbutton"
						id="btnAddOK" iconcls="icon-ok" onclick="update()">确定</a> 
						<a href="javascript:void(0)" class="easyui-linkbutton"
						iconcls="icon-cancel" onclick="javascript:$('#DivEdit').dialog('close')">关闭</a>
					</td>
				</tr>
			</table>
		</form>
