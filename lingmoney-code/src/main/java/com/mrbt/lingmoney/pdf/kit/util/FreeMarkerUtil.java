package com.mrbt.lingmoney.pdf.kit.util;
...
import com.mrbt.lingmoney.pdf.kit.exception.FreeMarkerException;
...
public class FreeMarkerUtil {
    ...
    public static String getPDFTemplatePath(String fileName){
        String templatePath=PropertiesUtil.getPropertiesByKey("PDF_TEMPLATES_PATH");//获取模板路径
