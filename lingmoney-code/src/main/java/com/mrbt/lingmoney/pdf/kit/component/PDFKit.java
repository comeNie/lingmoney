package com.mrbt.lingmoney.pdf.kit.component;
...
import com.mrbt.lingmoney.pdf.kit.component.builder.HeaderFooterBuilder;
import com.mrbt.lingmoney.pdf.kit.component.builder.PDFBuilder;
import com.mrbt.lingmoney.pdf.kit.exception.PDFException;
import com.mrbt.lingmoney.pdf.kit.util.FreeMarkerUtil;
...
public class PDFKit {
    ...
    public String exportToFile(String fileName, Object data){
        ...
        try{
            ...
            PDFBuilder builder = new PDFBuilder("", 12, PageSize.A4);
    ...
    public static String getFontPath() {
    	String templatePath=PropertiesUtil.getPropertiesByKey("PDF_FONTS_PATH");//获取模板路径
        return templatePath;
    }
