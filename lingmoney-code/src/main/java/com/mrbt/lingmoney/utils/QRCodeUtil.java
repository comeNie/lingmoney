...
public class QRCodeUtil {
	...
	public static BufferedImage encodeBufferedImage(String content, String imgPath, boolean needCompress)
			throws Exception {
		BufferedImage image = QRCodeUtil.createImage(content, imgPath, needCompress);
		return image;
		/* mkdirs(destPath); */
	...
	public static void main(String[] args) throws Exception {
		String text = AppCons.COMPANY_URL + "?referralTel=" + "000382";
		QRCodeUtil.encode(text, "D:/lingqian.gif", "D:/test", false);
