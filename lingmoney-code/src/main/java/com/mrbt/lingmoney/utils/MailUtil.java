...
public class MailUtil {
	 ...
	 * @param copyReceiver 邮件抄收者 [多个间用逗号隔开]
	 * @param title 邮件的标题
	 * @param content 邮件的内容
	 * @param sender 邮件发送者
	 * @param user 发送者邮箱用户名
	 ...
	 */
	public static boolean sendEmail(String smtpHost, String receiver, String copyReceiver, String title, String content,
			String sender, String senderNick, String user, String pwd, String fileUrl, String fileName)
			throws Exception {
	...
	public static void main(String[] args) {
		 try { 
			 sendEmail("smtp.wdzggroup.com", "yulong@wdzggroup.com.cn", "yulong@wdzggroup.com",
		  "测试附件", "252544983@qq.com", "yulong@wdzggroup.com", "yulong@wdzggroup.com", "ruochen=-09","", "E:/Temp/", "StructuredQuery.log");
