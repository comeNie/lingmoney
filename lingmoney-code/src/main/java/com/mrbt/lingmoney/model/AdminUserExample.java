...
public class AdminUserExample {
    ...
    /**
     * 第一个返回记录行的偏移量,admin_user
     */
    protected int limitStart = -1;

    /**
     * 返回记录行的最大数目,admin_user
     */
