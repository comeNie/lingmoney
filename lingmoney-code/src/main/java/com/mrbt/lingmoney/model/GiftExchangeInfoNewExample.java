...
public class GiftExchangeInfoNewExample {
    /**
     * 排序字段,gift_exchange_info_new
     */
    protected String orderByClause;

    /**
     * 是否过滤重复数据,gift_exchange_info_new
     */
    protected boolean distinct;

    /**
     * 查询条件实例,gift_exchange_info_new
     */
    protected List<Criteria> oredCriteria;

    /**
     * 第一个返回记录行的偏移量,gift_exchange_info_new
     */
    protected int limitStart = -1;

    /**
     * 返回记录行的最大数目,gift_exchange_info_new
     */
    protected int limitEnd = -1;

    /**
     *  构造查询条件,gift_exchange_info_new
     */
    public GiftExchangeInfoNewExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    /**
     *  设置排序字段,gift_exchange_info_new
    ...
    /**
     *  设置过滤重复数据,gift_exchange_info_new
    ...
    /**
     *  获取当前的查询条件实例,gift_exchange_info_new
     */
    ...
    /**
     *  增加或者的查询条件,用于构建或者查询,gift_exchange_info_new
    ...
    /**
     *  创建一个新的或者查询条件,gift_exchange_info_new
     */
    public Criteria or() {
    ...
    /**
     *  创建一个查询条件,gift_exchange_info_new
     */
    ...
    /**
     *  内部构建查询条件对象,gift_exchange_info_new
     */
    ...
    /**
     *  设置第一个返回记录行的偏移量,gift_exchange_info_new
    ...
    /**
     *  获取第一个返回记录行的偏移量,gift_exchange_info_new
     */
    ...
    /**
     *  设置返回记录行的最大数目,gift_exchange_info_new
    ...
    /**
     *  获取返回记录行的最大数目,gift_exchange_info_new
     */
