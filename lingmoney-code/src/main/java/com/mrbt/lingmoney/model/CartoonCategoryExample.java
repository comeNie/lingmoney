...
public class CartoonCategoryExample {
    /**
     * 排序字段,cartoon_category
     */
    protected String orderByClause;

    /**
     * 是否过滤重复数据,cartoon_category
     */
    protected boolean distinct;

    /**
     * 查询条件实例,cartoon_category
     */
    protected List<Criteria> oredCriteria;

    /**
     * 第一个返回记录行的偏移量,cartoon_category
     */
    protected int limitStart = -1;

    /**
     * 返回记录行的最大数目,cartoon_category
     */
    protected int limitEnd = -1;

    /**
     *  构造查询条件,cartoon_category
     */
    public CartoonCategoryExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    /**
     *  设置排序字段,cartoon_category
    ...
    /**
     *  增加或者的查询条件,用于构建或者查询,cartoon_category
    ...
    /**
     *  设置第一个返回记录行的偏移量,cartoon_category
    ...
    /**
     *  获取第一个返回记录行的偏移量,cartoon_category
     */
