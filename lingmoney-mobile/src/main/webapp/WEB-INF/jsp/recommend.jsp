...
<script type="text/javascript">
   $(function(){
	   var referralTel = GetQueryString("referralTel");
	   $(".number").text(referralTel);
   });
    ...
    //var recommendUrl = "http://app2.lingmoney.cn/";
    var recommendUrl = "http://10.20.1.88:8014/";
	wx.config({  
	    debug: false,  
	    appId: '${appId}',  
	    timestamp: '${timestamp}',  
	...
	wx.ready(function(){  
	    ...
	    wx.onMenuShareTimeline({  
	    	title: '领钱儿-拉新活动', // 分享标题  
	        link: recommendUrl + 'infoInterface/recommend?shareUrl=sharerecommend&referralTel=${referralTel}',  
	        imgUrl: recommendUrl + 'resource/images/bg.jpg' // 分享图标
	    });  
	    
	    wx.onMenuShareAppMessage({
	        title: '领钱儿-拉新活动', // 分享标题
	        desc: '领钱儿-拉新活动', // 分享描述
	        link: recommendUrl + 'infoInterface/recommend?shareUrl=sharerecommend&referralTel=${referralTel}', // 分享链接
	        imgUrl: recommendUrl + 'resource/images/bg.jpg', // 分享图标
	    			...
	    			$.ajax({
				        ...
				        success:function(data){
				        	if(data.code==200){
				        		...
				        		window.location.href="http://static.lingmoney.cn/share/lingmoney/index.html?from=singlemessage&isappinstalled=0";
				        	}else{
				        		showPop('<p style="text-align: center;padding:.2rem 0">'+data.msg+'</p>');
			...
			<div class="box-form">
				<ul>
					...
					<li ><input type="password"
						...
						<li style="margin-bottom: 0"><span>推荐人号码</span><span class="number">${referralTel}</span></li>
				</ul>
				<P class="checkbox">
