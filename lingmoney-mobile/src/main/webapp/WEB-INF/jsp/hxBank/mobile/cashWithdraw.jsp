...
<div class="panel panel-default">
	<div class="panel-heading">
		<a data-toggle="collapse" data-parent="#accordion" href="#collapse5">提现</a>
	</div>
	<div id="collapse5" class="panel-collapse collapse">
		<div class="panel-body">
			...
			<form action="/bank/cashWithdrawPage" method="post" target="_blank">
				<div class="input-group input-group-sm">
					<span class="input-group-addon">加密数据</span>
					<input type="text" class="form-control" name="params" id="accountOpenInput"/>
				</div>
				<input type="submit" class="btn btn-default btn-sm" value="提现" />
			</form>
		</div>
	</div>
</div>
