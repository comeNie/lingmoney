...
function docounty(){
	var province_option=$('#province option:selected');
	var citys_option=$('#citys option:selected');
	var county_option=$('#county option:selected');
	var inthearea=province_option.text()+citys_option.text()+county_option.text();
	$('#inthearea').text(inthearea);
	$('#inthearea').addClass('active');
	$('.as_na_select,.pop-mask').hide();
}
...
*/
function setdefault(){
	if($('.as_na_setdefault').hasClass('active')){
		$('.as_na_setdefault').removeClass('active');
	}else{
		$('.as_na_setdefault').addClass('active');
	}
}
