...
public class UserController extends BaseController {
	...
	@ResponseBody
	public Object updateUserDeviceToken(HttpServletRequest request, String deviceToken,
			Integer deviceType) {
		...
		try {
            ...
            if (StringUtils.isEmpty(uId)) {
                ...
                pageInfo = usersService.updateUserDeviceToken(uId, deviceToken, deviceType);
            }
		} catch (Exception e) {
			pageInfo.setCode(ResultInfo.SERVER_ERROR.getCode());
