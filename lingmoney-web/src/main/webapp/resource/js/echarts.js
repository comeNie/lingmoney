                ...
                if (p) {
                    ...
                    if (U[u](t), g[u](t), n || (U[V](), t = g[V]()), null != r) {
                        ...
                        if (p.type === a.CHART_TYPE_PIE && (f = d.legend) && (y = f.data)) {
                            var b = h.legend.data;
                            if (y[u](r), b[u](r), !n) {
                                var _ = o.indexOf(y, t.name); - 1 != _ && y.splice(_, 1),
...
function(e) {
    ...
    function o() {
        if (!c) if (e("../dep/excanvas"), window.G_vmlCanvasManager) {
            ...
            c = G_vmlCanvasManager.initElement(t).getContext("2d")
        } else c = document.createElement("canvas").getContext("2d");

        return c
    }
    function r() {
        return p || (m = document.createElement("canvas"), u = m.width, V = m.height, p = m.getContext("2d")),
        p
    }
    function s(e, t) {
        var i, n = 100;
        e + f > u && (u = e + f + n, m.width = u, i = !0),
        t + y > V && (V = t + y + n, m.height = V, i = !0),
        -f > e && (f = Math.ceil( - e / n) * n, u += f, m.width = u, i = !0),
        -y > t && (y = Math.ceil( - t / n) * n, V += y, m.height = V, i = !0),
        i && p.translate(f, y)
    }
    function l() {
        return {
                ...
                if (null != r) {
                    ...
                    if (d) if (c) {
                        ...
                        case s.CHART_TYPE_SCATTER:
                            ...
                            a = 0,
                            o = y.length; o > a; a++) if (null == y[a]._mark && l.get(y[a], "seriesIndex") == t && l.get(y[a], "dataIndex") == m) {
                                this._curTarget = y[a],
                                g = y[a].style.x,
                                f = d.type != s.CHART_TYPE_K ? y[a].style.y: y[a].style.y[0];
                                break
                            }
                            break;
                        case s.CHART_TYPE_RADAR:
                            for (var m = e.dataIndex,
                            a = 0,
                            o = y.length; o > a; a++) if ("polygon" === y[a].type && l.get(y[a], "seriesIndex") == t && l.get(y[a], "dataIndex") == m) {
                                this._curTarget = y[a];
                        ...
                        case s.CHART_TYPE_PIE:
                            for (var b = e.name,
                            a = 0,
                            o = y.length; o > a; a++) if ("sector" === y[a].type && l.get(y[a], "seriesIndex") == t && l.get(y[a], "name") == b) {
                                this._curTarget = y[a];
                                var _ = this._curTarget.style,
                                x = (_.startAngle + _.endAngle) / 2 * Math.PI / 180;
                                g = this._curTarget.style.x + Math.cos(x) * _.r / 1.5,
                                f = this._curTarget.style.y - Math.sin(x) * _.r / 1.5;
                                break
                            }
                            break;
                        case s.CHART_TYPE_MAP:
                            ...
                            k = r.mapType,
                            a = 0,
                            o = y.length; o > a; a++) if ("text" === y[a].type && y[a]._mapType === k && y[a].style._name === b) {
                                this._curTarget = y[a],
                                g = this._curTarget.style.x + this._curTarget.position[0],
                                f = this._curTarget.style.y + this._curTarget.position[1];
                                break
                            }
                            break;
                        case s.CHART_TYPE_CHORD:
                            for (var b = e.name,
                            a = 0,
                            o = y.length; o > a; a++) if ("sector" === y[a].type && l.get(y[a], "name") == b) {
                                this._curTarget = y[a];
                                var _ = this._curTarget.style,
                                x = (_.startAngle + _.endAngle) / 2 * Math.PI / 180;
                                return g = this._curTarget.style.x + Math.cos(x) * (_.r - 2),
                                f = this._curTarget.style.y - Math.sin(x) * (_.r - 2),
                        ...
                        case s.CHART_TYPE_FORCE:
                            for (var b = e.name,
                            a = 0,
                            o = y.length; o > a; a++) if ("circle" === y[a].type && l.get(y[a], "name") == b) {
                                this._curTarget = y[a],
                                g = this._curTarget.position[0],
                                f = this._curTarget.position[1];
                                break
                            }
                        }
...
function(e) {
    ...
    function X(e, t, i) {
        ...
        i = 1 - T(i, [0, 1]);
        for (var n = 2 * i - 1,
        a = K(u(e)), o = K(u(t)), r = a[3] - o[3], s = ((n * r === -1 ? n: (n + r) / (1 + n * r)) + 1) / 2, l = 1 - s, h = [], d = 0; 3 > d; d++) h[d] = a[d] * s + o[d] * l;
        var m = a[3] * i + o[3] * (1 - i);
...
function(e) {
    ...
    u = {
        ...
        click: function(e) {
            ...
            var t = this._lastHover; (t && t.clickable || !t) && this._clickThreshold < 5 && this._dispatchAgency(t, c.CLICK, e),
            this._mousemoveHandler(e)
        },
        dblclick: function(e) {
            e = e || window.event,
            e = this._zrenderEventFixed(e);
            var t = this._lastHover; (t && t.clickable || !t) && this._clickThreshold < 5 && this._dispatchAgency(t, c.DBLCLICK, e),
            this._mousemoveHandler(e)
        },
        ...
        mousedown: function(e) {
            ...
            2 == this._lastDownButton ? (this._lastDownButton = e.button, void(this._mouseDownTarget = null)) : (this._lastMouseDownMoment = new Date, e = this._zrenderEventFixed(e), this._isMouseDown = 1, this._mouseDownTarget = this._lastHover, this._dispatchAgency(this._lastHover, c.MOUSEDOWN, e), void(this._lastDownButton = e.button))
        },
        mouseup: function(e) {
            e = this._zrenderEventFixed(e),
            this.root.style.cursor = "default",
        ...
        touchend: function(e) {
            ...
            var t = new Date;
            t - this._lastTouchMoment < c.touchClickDelay && (this._mobileFindFixed(e), this._clickHandler(e), t - this._lastClickMoment < c.touchClickDelay / 2 && (this._dblclickHandler(e), this._lastHover && this._lastHover.clickable && s.stop(e)), this._lastClickMoment = t),
                        ...
                        var z = function(e, o) {
                            ...
                            if (0 !== d) {
                                if (w = (o - x[v]) / d, m) if (I = k[v], X = k[0 === v ? v: v - 1], K = k[v > U - 2 ? U - 1 : v + 1], S = k[v > U - 3 ? U - 1 : v + 2], f) r(X, I, K, S, w, w * w, w * w * w, l(e, V), b);
                                    ...
                                    var c;
                                    y ? (c = r(X, I, K, S, w, w * w, w * w * w, E, 1), c = h(E)) : c = s(X, I, K, S, w, w * w, w * w * w),
                                    i(e, V, c)
        ...
        _markLine: function() {
            ...
            return function(i, n) {
                ...
                for (var w = [], g = 0, X = m.length; X > g; g++) {
                    ...
                    a.type === h.CHART_TYPE_MAP && (S._geo = [this.getMarkGeo(f[0]), this.getMarkGeo(f[1])]),
                    d.pack(S, a, i, f[0], g, f[0].name + ("" !== f[1].name ? " > " + f[1].name: ""), x),
                    w.push(S)
                }
                return w
            }
...
function(e) {
    ...
    function n() {
        p = U.logLabelBase,
        null == p ? (u = "plain", p = 10, V = K) : (p = +p, 1 > p && (p = 10), u = "exponent", V = v(p)),
        g = U.splitNumber,
        null == g && (g = E);
