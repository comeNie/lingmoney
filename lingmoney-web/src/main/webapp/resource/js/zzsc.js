...
if (sD > -1 && sD < cld.length) { // 日期内
	...
	if (cld[sD].isToday) {
		...
		sObj.style.fontSize = '25px';
	} // 今日颜色
	else {
		sObj.style.color = '';
	}
	if (cld[sD].lDay == 1) { // 显示农历月
		lObj.innerHTML = '<b>' + (cld[sD].isLeap ? '闰' : '') + cld[sD].lMonth
				+ '月'
...
/*
 * if(parseInt(sObj.innerHTML)%5==0){ sObj.style.color = 'red'; }
 */
