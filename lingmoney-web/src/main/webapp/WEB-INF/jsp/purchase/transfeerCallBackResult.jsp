			...
			<div class="changepas">
				<div style="margin: 0 auto; width: 875px;">
				 <c:if test="${status=='S'}">
					...
					<c:if test="${status=='R'}">
						<div style="padding: 60px 0 16px 0; border-bottom: 1px solid #e5e5e5; text-align: center">
							<img src="/resource/images/img_returnManaging.gif">
						</div>
					</c:if>
					<div style="padding-bottom: 200px;">
						<p style="padding: 20px 0 73px 0; font-size: 18px; color: #362e2b; text-align: center"><span id="spanSecond">5</span>秒种后将自动返回我的领钱儿。</p>
						<p style="text-align: center">
							<a href="/myFinancial/finanCialManage">我的理财</a> 
							<a href="/myLingqian/show" >我的领钱儿</a>
						</p>
					</div>
				</div>
