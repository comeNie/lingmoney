						...
						<div class="quxian">
							...
							<div class="div-time">
								请选择年月： <input id="hello" class="ymcalendar" readonly="readonly"/><span></span> <a
									href="javascript:void(0)" onclick="ok()" class="laydate-ok">确定</a>
							</div>
							<div id="chart"
...
<script type="text/javascript">
	...
	require([ 'echarts', 'echarts/chart/bar', 'echarts/chart/line' ], function(
		...
		var noCache = Date();
		// 加载数据  
		$.getJSON('/trading/getData.html?date_time=' + date_time,{"noCache":noCache},
							function(json) {
