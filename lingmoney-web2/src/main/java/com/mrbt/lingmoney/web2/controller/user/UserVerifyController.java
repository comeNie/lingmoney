...
public class UserVerifyController {
	...
	public @ResponseBody  Object regist(HttpServletRequest request, String telephone, String loginPsw, String referralTel, String verificationCode, Integer channel) {
		log.info("users-用户注册,并登录");
		...
		try {
			...
			if (pageInfo.getCode() == ResultInfo.SUCCESS.getCode()) {
				...
				log.error("手机：" + telephone + "注册失败:");
			}

		} catch (Exception e) {
			CommonMethodUtil.handelCatchedException(pageInfo, e, log, "注册或登录失败");
		}
		return pageInfo;
	}
