...
public class BankAccountController extends BaseController {
	...
	public @ResponseBody Object accountOpen(HttpServletRequest request, HttpServletResponse response, String acName, String mobile, String idNo) {
		LOGGER.info("银行账户开立");
		...
		try {
            ...
            if (StringUtils.isEmpty(uId)) {
				...
				pageInfo = bankAccountService.requestAccountOpen(uId, acName, idNo, mobile, CLIENT_TYPE, APP_ID);
            }
    ...
    public void accountOpenCallBack(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            response.sendRedirect(HX_CALL_BACK_OPER_PAGE + status + "&oper=1");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
